...
module.exports = {
  ...
  CONTACT_TWITTER:
    process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/zhengjunyaocn', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/zhengjy01', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  CONTACT_XIAOHONGSHU:
    ...
    'https://www.xiaohongshu.com/user/profile/5fccc738000000000101ca61', // 小红书主页
  CONTACT_JIKE:
    process.env.NEXT_PUBLIC_CONTACT_JIKE || 'https://okjk.co/kVcj6W', // 即刻主页
