export default {
  ...
  MAILCHIMP: {
    SUBSCRIBE: 'Abone Ol',
    MSG: 'Yeni yazılar yayınlandığında e-postanıza gönderilsin.',
    EMAIL: 'E-posta',
    SUCCESS: 'Abonelik başarılı, teşekkürler!',
    ERROR: 'Abonelik başarısız, lütfen daha sonra tekrar deneyin'
  },
  CONTACT: 'İletişim',
  AI_SUMMARY: {
